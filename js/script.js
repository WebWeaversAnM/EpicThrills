...
$(document).scroll(function(){
  if($(this).scrollTop()>a){
    $('.navbar-default').css({"box-shadow":"0 12px 16px 0 rgba(0,0,0,0.24), 0 17px 50px 0 rgba(0,0,0,0.19)"});
    $('.navbar-default').css({"background-color":"white","border-color":"#E2FFD3"});
